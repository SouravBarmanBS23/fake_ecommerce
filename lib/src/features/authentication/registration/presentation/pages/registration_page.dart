...
class _LoginPageState extends ConsumerState<RegistrationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final userRegistration = ref.read(authenticationProvider);
    //bool userRegistrationStatus = ref.watch(authenticationProvider.notifier).state;
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      RegistrationProvider userRegistration1 = RegistrationProvider();
                         userRegistration1.register(regModel);
                      ...
                      userRegistration.when(
                          data: (data){
                            if(data == true){
                              ...
                              print('data is false');
                              return GoRouter.of(context).go('/registration');
                            }
                          },
