...
class _LoginPageState extends ConsumerState<RegistrationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final setRegistration = ref.read(registrationProvider.notifier);
    final authStatus = ref.watch(registrationProvider);

    return authStatus == RegistrationState.loading ? const Scaffold(body: Center(child: CircularProgressIndicator(),)) :
        authStatus == RegistrationState.success ? const LoginPage() : authStatus == RegistrationState.initial ?
      GestureDetector(
